                ...
                <div className="container relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-dark/60 max-w-3xl font-medium leading-relaxed">
                            Nykyaikaisilla mukavuuksilla varustettua liiketilaa yrityksesi kasvun tueksi Porissa.
                        </p>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="py-20 md:py-32 container">
                <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-center">
                    ...
                    >
                        ...
                        <h2 className="text-3xl md:text-5xl font-black mb-8 tracking-tight text-dark">Tilaa Kasvolle</h2>
